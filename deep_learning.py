...
print("n neurons output: ", n_neurons_output)
...
for h in n_hidden:                          #looking or the best parameters w.r.t the number of hidden layers
    for n in n_neurons:                     #looking or the best parameters w.r.t the number of neurons
        for l in l_rate:                    #looking or the best parameters w.r.t the learning rate
            ...
            model = build_model(h, n, n_neurons_output, l)
            ...
            # print("len of class predicted: ", len(class_predicted))
            # print("len of y test: ", len(y_test))
            for i,prediction in enumerate(class_predicted):
            ...
            print("num of correct predictions: ", num_of_correct_predictions)
            new_accuracy = num_of_correct_predictions / len(y_test)
